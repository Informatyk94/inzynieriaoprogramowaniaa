...
<div class="row">
  ...
  <div class="col-md-8">
	<div style="background-color:#EFEFEF; padding:15px">
				<h1>TEST</h1>
				<h5>1.Pytanie</h5>
				<h6>Czy Inżynieria oprogramowania to dziedzina inżynierii, która obejmuje wszystkie aspekty tworzenia oprogramowania od fazy początkowej do jego pielęgnacji?</h6>
				<form method="post" action="lekcja2testwynik.php">
				<div class="radio">
					  <label>
				...
				<br>
				<h5>2.Pytanie</h5>
				<h6>Czy zanie jest Prawdziwe? Inżynieria systemów komputerowych obejmuje wszystkie aspekty tworzenia i ewolucji systemów komputerowych, w których oprogramowanie odgrywa zasadniczą rolę. 
				Inżynierowie systemów biorą udział  w specyfikacji systemu i definiowania jego ogólnej architektury</h6>
				<div class="radio">
					  <label>
				...
				<h5>3.Pytanie</h5>
				<h6>Czy zdanie jest prawdziwe? Jest to zbiór czynności i związanych z nimi wyników, które zmierzają do opracowania produktu programowego
				Zasadnicze czynności wspólne dla wszystkich procesów
				Specyfikacja oprogramowania 
				Tworzenie oprogramowania 
				Zatwierdzenie oprogramowania 
				Ewolucja oprogramowania?</h6>
				<div class="radio">
					  <label>
					...
					<h5>4.Pytanie</h5>
				<h6>Czy istnieje coś takiego jak Model kaskadowy?</h6>
